  ...
  <div class="space-y-10">
    ...
    >
      <div class="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          <UBadge color="primary" variant="subtle" class="uppercase tracking-widest">
            Pokemon collection
          </UBadge>
          <h1 class="mt-5 max-w-2xl text-3xl font-semibold tracking-tight text-highlighted sm:text-4xl lg:text-5xl">
        ...
        <div class="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
          ...
          <UCard :ui="{ body: 'p-5' }">
            ...
            <p class="mt-3 text-lg font-semibold text-highlighted">
              {{
                authResolved ? (user ? nickname : "Guest browsing mode") : "Checking session..."
              }}
            </p>
            <p class="mt-2 text-sm text-muted">
              {{
